...
/*
    Задание 5.3.3.
    Ограничьте доступ к записи неправильных данных извне структуры Human.
    Объявите поля, которые вы не используете напрямую снаружи Human, 
    как private. Методы структуры объявите public.
*/
struct Human
{
private:
